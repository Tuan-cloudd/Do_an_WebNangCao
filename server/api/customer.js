...
router.get('/products/category/:cid', async function (req, res) {
  const _cid = req.params.cid;              // lấy category id từ URL
  const products = await ProductDAO.selectByCatID(_cid);  // gọi DAO để lấy sản phẩm theo category
  res.json(products);                       // trả dữ liệu JSON về client
});
